...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    "Zinn Architektur in Riem, Sparkasse Immobilien, HM Immobilien München. Vorverkauf, Anfragen mit WE-Bezug, Mandate.",
  path: "/referenzen",
});
  ...
  return (
    <main>
      ...
      <PageHero
        ...
        lead="Riem, Sparkasse, Maklerbüro. Keine Kampagnenbilder. Was im Alltag liegt."
        tone="blatt"
        ...
        <div className="container overlap-fassade" style={{ paddingTop: 0, paddingBottom: 0 }}>
          <div>
            ...
            <p className="lead">
              ...
              Vertrieb hat mit Leuten gesprochen, die eine WE kannten.
            </p>
      ...
      <section className="section bg-white border-b">
        <div className="container" style={{ maxWidth: "40rem" }}>
          ...
          <h2>Anfrage mit Merkliste, Übergabe nach onOffice.</h2>
          <p className="lead">
            Vorher: Portal-Landing, Formular, leere Termine. Seit der Finder in
            der Seite sitzt, kommt die WE mit. Import nach onOffice.
          </p>
        </div>
      </section>

      <section className="section bg-sonne border-b">
        <div className="container" style={{ maxWidth: "40rem" }}>
